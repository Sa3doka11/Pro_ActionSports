...
(function () {
    ...
    function renderHomeCategories(categories = []) {
        ...
        safeSetHTML(leftColumn, sanitizeHtmlContent(leftItems.map(createItem).join('')));
        safeSetHTML(rightColumn, sanitizeHtmlContent(rightItems.map(createItem).join('')));
    }
